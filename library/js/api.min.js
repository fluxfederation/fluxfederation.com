...
$(document).ready(function(){$(".events-page").length?function(){return new Promise((a,b)=>{$.ajax({url:"https://fluxfederation.wpengine.com/wp-json/fluxapi/v1/events",crossDomain:!0,success:function(b){a(b)},error:function(a){b(a)}})})}().then(a=>addEventsToPage(a)):"",$(".blog-page").length?function(){return new Promise(a=>{$.ajax({url:"https://fluxfederation.wpengine.com/wp-json/fluxapi/v1/posts",crossDomain:!0,success:function(b){a(b)},error:function(a){console.log(a)}})})}().then(a=>addBlogsToPage(a)):"",addEventsToPage=a=>{html=`<section class="white"><article class="wrap cf">`,$.each(a.reverse(),(a,b)=>html+=eventItem(b)),html+=`</section>`,$(".events-page").append(html)},addBlogsToPage=a=>{console.log(a)},eventItem=a=>(html=`<div class="table-layout">
