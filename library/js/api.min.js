...
c.append(html)},i=a=>{const b=d(a.start_date),c=a.end_date?d(a.end_date):null;return`${b.weekday} ${b.day} ${b.month_short} ${a.end_date?`- ${c.weekday} ${c.day} ${c.month_short}`:""}`},j=a=>(html=`<div class="m-all t-4of12 news-item">
		...
		</div>`,html),m=a=>(console.log(a),date=d(a.date_written),html=`<div class="cf item-info">
			<strong><p class="item-info-text-margin">${a.author_name}</p></strong>
			<br>
			<p class="item-meta-info">${date.month_short} ${date.day} | ${a.read_time} min read</p>
		</div>`,html),o=a=>`<div class="flux-button news-item-button"><a href="/newsroom/blog/post/?name=${a}">Read More</a></div>`,p=a=>`<div class="flux-button news-item-button"><a target="_blank" href="${a}">Read More</a></div>`,q=a=>(html=`<div class="m-all t-4of12 news-item">
			...
			${o(a.post_name)}
		</div>`,html),r=a=>(html=`<div class="news-item">
...
>>>>>>> a20390ae92174c7a243142c014001682b7f787b5
