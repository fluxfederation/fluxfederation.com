...
$(document).ready(function(){$(".events-page").length&&function(){return new Promise((a,b)=>{$.ajax({url:"https://fluxfederation.wpengine.com/wp-json/fluxapi/v1/events",crossDomain:!0,success:function(b){a(b)},error:function(a){b(a)}})})}().then(a=>$.each(a.reverse(),(a,b)=>$(".events-page").append(buildEventItem(b)))),buildEventItem=a=>(console.log(a),html=`<section class="white">
			<article class="wrap cf">
				<div class="m-all t-1of2 d-8of12" style="height: 100%;"> 
					<div style="background-image: url(${a.image_url}); width: 100%; height: 100%; display: inline-block;"></div>
				</div>
