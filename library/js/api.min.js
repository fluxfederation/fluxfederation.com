...
$(document).ready(function(){$(".case-studies-page").length?function(){return console.log("testt"),new Promise((a,b)=>{$.ajax({url:"https://cms.fluxfederation.com/wp-json/fluxapi/v1/case-studies",crossDomain:!0,success:b=>a(b),error:a=>b(a)})})}().then(a=>addCaseStudiesToPage(a)):"",addCaseStudiesToPage=a=>{console.log(a),html=`<article class="wrap cf">`,$.each(a.reverse(),(a,b)=>html+=caseStudyItem(b)),html+=`</article>`,$(".case-studies-page").append(html)},caseStudyItem=()=>(html=`<div class="m-all t-4of12 news-item">
