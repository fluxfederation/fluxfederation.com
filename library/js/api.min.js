...
$(".blog-section").append(html)},j=a=>(date=e(a.start_date),html=`<div class="m-all t-4of12 news-item">
			...
			<div class="cf item-info">
				...
				<p><a href="${a.ics_file}">Add to Calendar</a></p><br><br>
				<strong><p><a target="_blank" href="${k(a.location.address)}">${a.location.address.split(",")[0]}</a></p></strong>
				<br>
				<p class="preview">${a.description}</p>
			</div>
		</div>`,html),k=a=>`http://www.google.com/maps/?q=${encodeURIComponent(a)}`,l=a=>(console.log(a),date=e(a.date_written),html=`<div class="cf item-info">
